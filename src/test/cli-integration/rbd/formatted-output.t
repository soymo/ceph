...
# test formatting
  ...
  \tblock_name_prefix: rb.0.* (glob) (esc)
  \tformat: 1 (esc)
  ...
  $ rbd info foo --format xml | xml_pp
  <image>
    <name>foo</name>
  ...
  $ rbd info foo@snap --format xml | xml_pp
  <image>
    <name>foo</name>
    <size>1073741824</size>
    <objects>256</objects>
  ...
  \tsize 1024 MB in 256 objects (esc)
  \torder 22 (4096 KB objects) (esc)
  \tblock_name_prefix: rbd_data.* (glob) (esc)
  \tformat: 2 (esc)
  ...
  $ rbd info bar --format xml | xml_pp
  <image>
    <name>bar</name>
    <size>1073741824</size>
    <objects>256</objects>
  ...
  $ rbd info bar@snap --format xml | xml_pp
  <image>
    <name>bar</name>
    <size>536870912</size>
    <objects>128</objects>
  ...
  $ rbd info bar@snap2 --format xml | xml_pp
  <image>
    <name>bar</name>
    <size>1073741824</size>
    <objects>256</objects>
  ...
  $ rbd info baz --format xml | xml_pp
  <image>
    <name>baz</name>
  ...
  \torder 22 (4096 KB objects) (esc)
  \tblock_name_prefix: rb.0.1364.* (glob) (esc)
  \tformat: 1 (esc)
  ...
  $ rbd info quux --format xml | xml_pp
  <image>
    <name>quux</name>
    <size>1048576</size>
    <objects>1</objects>
  ...
  $ rbd info data/child --format xml | xml_pp
  <image>
    <name>child</name>
    <size>536870912</size>
    <objects>128</objects>
  ...
  $ rbd info data/child@snap --format xml | xml_pp
  <image>
    <name>child</name>
    <size>536870912</size>
    <objects>128</objects>
  ...
  $ rbd list data --format xml | xml_pp
  <images>
    <name>child</name>
  </images>
  $ rbd list data -l
  ...
  $ rbd list data -l --format xml | xml_pp
  <images>
    <image>
      <image>child</image>
      <size>536870912</size>
  ...
  {}
  $ rbd lock list foo --format xml | xml_pp
  <locks></locks>
  $ rbd lock list quux
  ...
  $ rbd lock list quux --format xml | xml_pp
  <locks>
    <id>
  ...
  $ rbd lock list baz --format xml | xml_pp
  <locks>
    <id*> (glob)
      <locker>client.*</locker> (glob)
      <address>*</address> (glob)
  ...
  $ rbd snap list foo --format xml | xml_pp
  <snapshots>
    <snapshot>
      <id>*</id> (glob)
      <name>snap</name>
  ...
  $ rbd snap list bar --format xml | xml_pp
  <snapshots>
    <snapshot>
      <id>*</id> (glob)
      <name>snap</name>
  ...
  []
  $ rbd snap list baz --format xml | xml_pp
  <snapshots></snapshots>
  ...
  $ rbd snap list data/child --format xml | xml_pp
  <snapshots>
    <snapshot>
      <id>*</id> (glob)
      <name>snap</name>
